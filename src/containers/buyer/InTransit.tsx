...
function InTransitOrders({orderss}: any) {
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg">
      <h1 className="text-3xl font-bold mb-6">Paid Orders</h1>
      <div className="space-y-4 h-64 flex justify-center items-center">
           ...
           currentOrders.map((order:any) => (
            <div key={order.id} className="border border-gray-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="order-body flex justify-between items-center">
                <p className="text-gray-600">{order.updatedAt}</p>
                ...
                <button 
                  ...
                  onClick={() => dispatch(setActiveMenu({ activeMenu: "order-details" }))}
                >
                  Details
                </button>
              </div>
